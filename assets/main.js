							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Pieniadze',
										'page_location': 'https://wspolpraca.hawrantravel.pl/#pieniadze',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Atuty',
										'page_location': 'https://wspolpraca.hawrantravel.pl/#atuty',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Umowa',
										'page_location': 'https://wspolpraca.hawrantravel.pl/#umowa',
									});
								},
							],
						},
							...
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										...
										'page_location': 'https://wspolpraca.hawrantravel.pl/#rejestracja',
									});
								},
							],
						},
						...
						events: {
							onopen: [
								function() { 
									gtag('event', 'page_view', {
										'page_title': 'Home',
										'page_location': 'https://wspolpraca.hawrantravel.pl',
									});
								},
							],
						},
